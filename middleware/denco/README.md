...
## Installation
    ...
    go get -u github.com/baishancloud/go-openapi-runtime/middleware/denco
...
See [Godoc](http://godoc.org/github.com/baishancloud/go-openapi-runtime/middleware/denco) for more details.

## Getting the value of path parameter

You can get the value of path parameter by 2 ways.

1. Using [`denco.Params.Get`](http://godoc.org/github.com/baishancloud/go-openapi-runtime/middleware/denco#Params.Get) method
2. Find by loop
...
## Benchmarks
    ...
    cd $GOPATH/github.com/baishancloud/go-openapi-runtime/middleware/denco
